  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`hidden sm:grid rounded-xl overflow-hidden shadow-lg bg-background border border-accent/30 group aspect-[4/5]`}
      >
        ...
        <div className="absolute inset-0 bg-foreground/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <div className="text-center p-4">
              ...
              <Link
                href={project.link}
                className="inline-flex items-center text-accent hover:text-accent-strong transition-colors duration-300"
                target="_blank"
      ...
      <motion.div
        whileHover={{ y: -5 }}
        transition={{ duration: 0.3 }}
        className={`sm:hidden grid grid-cols-5 rounded-xl overflow-hidden shadow-lg bg-background border border-accent/30 group aspect-[5/3]`}
      >
        ...
        <div className="col-span-3 p-4 flex flex-col justify-center">
          ...
          <p className="text-foreground/60 text-xs line-clamp-2">{project.description}</p>
        </div>
