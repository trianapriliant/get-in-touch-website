          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="bg-background rounded-xl shadow-md p-8 border border-accent">
                <h2 className="text-2xl font-bold mb-6 text-accent">What inspires your design philosophy?</h2>
                ...
                <h2 className="text-2xl font-bold mb-6 text-accent">How do you approach a new project?</h2>
                <p className="text-foreground/80 mb-8">
                ...
                <h2 className="text-2xl font-bold mb-6 text-accent">What tools do you use in your workflow?</h2>
                <p className="text-foreground/80 mb-8">
                ...
                <h2 className="text-2xl font-bold mb-6 text-accent">How do you stay updated with industry trends?</h2>
                <p className="text-foreground/80 mb-8">
                ...
                <h2 className="text-2xl font-bold mb-6 text-accent">What makes a project successful in your opinion?</h2>
